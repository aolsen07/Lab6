...
function initFormHandler() {
  ...
  let submitButton = formElement.querySelector('button').addEventListener('click', () => {
  ...
  let clearStorage = formElement.querySelector('button.danger').addEventListener('click', () => {
    localStorage.clear();
